...
This publication - reference OIML R 129-2, Edition 2020 (E) - was developed by Project Group 1 in the OIML Technical Subcommittee TC 7/SC 5 Dimensional Measuring Instruments. It was approved for final publication by the International Committee of Legal Metrology in 2020. It supersedes the previous edition dated 2000.
