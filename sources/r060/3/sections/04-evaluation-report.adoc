...
to any other OIML Issuing Authority (see <<OIML_CS>>, 4.1.2 b)
| &#x2610; Yes | &#x2610; No
3+| Remarks:
...
| Analogue data processing device (see <<OIML_R_76_2006>>, T.2.2.3) |
| Cables                                                       |
| Load cell mounting hardware                                  |
| Load introduction elements                                   |
| Main power supply                                            |
| Battery (type, voltage)                                      |
| Indicator (see <<OIML_R_76_2006>>, T.2.2.2)                       |
| Data printer                                                 |
| Other accessories:                                           |
|===
...
(refer to <<OIML_R_60_2,clause="2.3">>, <<OIML_R_60_2,clause="2.4">> and <<OIML_R_60_2,annex="D">>):
...
(Refer to <<OIML_R_60_1,clause="6.2.2">>, <<OIML_R_60_1,clause="6.2.3">> and <<OIML_R_60_1,clause="6.2.4">>)
